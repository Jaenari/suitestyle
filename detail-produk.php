...
if (isset($_GET['id'])) {
    ...
    echo "<script>alert('Pilih Produk terlebih dahulu'); window.location='index.php'<script>";
}
?>
        ...
        <div class="container">
            ...
            <div class="product-detail-box mb-4">
                ...
                <div class="product-image">
                    <img src="produk/<?php echo htmlspecialchars($p->produk_image); ?>"
                        alt="<?php echo htmlspecialchars($p->produk_nama); ?>">
                </div>
                ...
                <div class="product-info">
                    ...
                    <div class="product-description">
                        ...
                        <p><?php echo nl2br(htmlspecialchars($p->produk_deskripsi)); ?>
                        <h2 class="mt-2">Warna</h2>
                        <h4><?php echo htmlspecialchars($p->warna); ?></h4>
                        </p>
                    </div>
                    ...
                    <div class="product-action">
                        ...
                        <a href="checkout.php?produk_id=<?php echo urlencode($p->produk_id); ?>"
